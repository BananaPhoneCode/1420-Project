...
public class Student {
    ...
    public Student(String SN, String SI, String SA, String ST,String STT,String SC, String SE, String SG, String SS, String SSS, String SL, String STTT, String SP){
        this.StudentName = SN;
        this.StudentId = SI;
    ...
    public String getStudentProg(){return this.StudentProg;}
}
